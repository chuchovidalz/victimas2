...
function LostpassTemplate($user,$link) {
  ...
  <div style="">
  	...
  	<p>El día '. date('d/m/Y', time()).' se ha generado una solicitud de recupeción de contraseña. <br /> Si no has solicitado esto, has caso omiso a este mensaje. En cambio si deseas recuperar tu contraseña debes hacer clic en el enlace de abajo.</p>
